<template>
    <div class="bg-gray-950 p-3 rounded-t-md grid place-items-center">
        <span class="flex items-center space-x-3 select-none text-gray-50">
            <ChevronLeftIcon class="h-5 w-5 text-gray-400 cursor-pointer icon-color-theme" @click="()=>modifyYear(-1)"/>
            <span class="w-20 text-center">{{year}}</span>
            <ChevronRightIcon class="h-5 w-5 text-gray-400 cursor-pointer icon-color-theme" @click="()=>modifyYear(1)"/>
        </span>
    </div>
</template>
